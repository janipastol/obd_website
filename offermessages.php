...
<!-- Mirrored from demo.graygrids.com/themes/classified/offermessages.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 16:10:18 GMT -->

<head>
    <meta charset="utf-8">

    <!--====== Title ======-->
    <title>Offers/Messages | ClassiFied</title>
...
<body class="gray-bg">
    ...
    <section class="offers_messages_page pt-70 pb-40">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                        ...
                        <div class="profile_user">
                            ...
                            <div class="user_list">
                                <ul>
                                    ...
                                    <li><a class="active" href="offermessages.php"><i class="fal fa-envelope"></i> Offers/Messages</a></li>
                ...
                <div class="col-lg-9">
                    <div class="offers_messages_content mt-50">
                        <div class="post_title">
                            <h5 class="title">Offers/Messages</h5>
                        </div>
                        ...
                        <div class="offers_messages_inbox pt-20">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <div class="inbox_chat">
                                        ...
                                        <div class="inbox_chat_wrapper">
                                            <div class="single_chat chat_online d-flex align-items-center">
                                                <div class="chat_author">
                                                    <img src="assets/images/author-1.jpg" alt="author">
                                                </div>
                                                <div class="chat_content media-body">
                                                    <h6 class="name">James Miller</h6>
                                ...
                                <div class="col-md-8">
                                    <div class="inbox_massage">
                                        ...
                                        <div class="inbox_massage_wrapper">
                                        ...
                                        <div class="massage_type">
                                            <textarea placeholder="Type Here & Press Enter"></textarea>
