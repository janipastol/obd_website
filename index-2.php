...
<body class="gray-bg">
    ...
    <header class="header_area">
        ...
        <div class="header_content bg_cover" style="background-image: url(assets/img/bg-3.jpg)">
            <div class="container">
                <div class="row" style="justify-content: center">
                    <div class="col-lg-10">
                        <div class="content_wrapper" >
                            <h3 class="title text-center" style="color: #ff4367;">
                                Welcome to Online
                                <span style="
                            ...
                            <h2 class="text-center" style="color: #fff; text-transform: uppercase">
                                <span style="
                      background-color: #ff4367;
                      padding: 0 10px;
                      border-radius: 15px;
            ...
            ">
                        ...
                        <div class="content_wrapper">
                            <div class="row" style="display: flex; align-items: center">
                                <div class="col-md-9 col-sm-12">
                                    <h2 class="title" id="business-title">
                                        Industrial Bussiness Rates
                                    </h2>
                                </div>
                                <div class="col-md-3 col-sm-12 text-center">
                                    <button class="main-btn" style="background-color: #463ce5 !important">
                                        Sign Up
                                    </button>
                                </div>
                            </div>
                ...
                <div class="header_search" style="padding-bottom: 10px !important; margin-top: 40px !important; ">
                    <div class="row" style="display: flex; align-items: center">
                      <div class="col-lg-9 col-md-9 col-sm-12 text-center">
                        <h1 class="title" style="color: #fff; font-size: 55px">
                          Industrial Business Rates
                        </h1>
                      </div>
                      <div
                        class="col-lg-3 col-md-3 col-sm-12 justify-content-center align-items-center text-center"
                      >
                        <button
    ...
    <section class="category_area pt-50">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="tab-pane fade show active" id="popular" role="tabpanel" aria-labelledby="popular-tab">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6">
                                <div class="single_ads_card ">
                                    <div class="ads_card_image">
                                        <img src="assets/img/10e9450c42e7ab778e87df79a33b88539cddd0ad26939.webp" alt="ads" />
                                    </div>
                                    <div class="ads_card_content">
                                        ...
                                        <div class="ads_price_date d-flex justify-content-between">
                                            <span class="price">PKR 65000</span>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single_ads_card ">
                                    <div class="ads_card_image">
                                        <img src="assets/img/378150_535405_xiaomi-12-pro-5g-dual-sim-8256gb-blue.jpg" alt="ads" />
                                    ...
                                    <div class="ads_card_content">
                                        ...
                                        <div class="ads_price_date d-flex justify-content-between">
                                            <span class="price">PKR 53000</span>
                                            <span class="date">25 Jan, 2023</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single_ads_card ">
                                    <div class="ads_card_image">
                                        <img src="assets/img/49a7cc389ee4830574db78840df5864489193d1c89564.webp" alt="ads" />
                                    </div>
                                    <div class="ads_card_content">
                                        <div class="meta d-flex justify-content-between">
                                        ...
                                        <div class="ads_price_date d-flex justify-content-between">
                                            <span class="price">PKR 400000</span>
                                            <span class="date">25 Jan, 2023</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="single_ads_card ">
                                    <div class="ads_card_image">
                                        <img src="assets/img/75733-2ed09-zaschita-gryadki-ot-zhivotnyh.jpg" alt="ads" />
                                        <p class="sticker">Featured</p>
                                    </div>
                                    <div class="ads_card_content">
                                        <div class="meta d-flex justify-content-between">
                                            <p>Huawei Mate Pad T</p>
                                            <a class="like" href="#"><i class="fal fa-heart"></i></a>
                                        </div>
                                        <h4 class="title">
                                        ...
                                        <div class="ads_price_date d-flex justify-content-between">
                                            <span class="price">PKR 120000</span>
                                            <span class="date">25 Jan, 2023</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="published_wrapper">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_ads_card ">
                            <div class="ads_card_image">
                                <img src="assets/img/fortuner.jpeg" alt="ads" />
                            </div>
                            <div class="ads_card_content">
                                <div class="meta d-flex justify-content-between">
                                    <p>Toyota Fortuner 2023</p>
                                    <a class="like" href="#"><i class="fal fa-heart"></i></a>
                                </div>
                                <h4 class="title">
                                ...
                                <p><i class="far fa-map-marker-alt"></i>Karachi, Pakistan</p>
                                <div class="ads_price_date d-flex justify-content-between">
                                    <span class="price">PKR 17500000</span>
                                    <span class="date">25 Jan, 2023</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_ads_card ">
                            <div class="ads_card_image">
                                <img src="assets/img/car.webp" alt="ads" />
                                <p class="sticker sticker_color-1">New</p>
                            </div>
                            <div class="ads_card_content">
                                <div class="meta d-flex justify-content-between">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_ads_card ">
                            <div class="ads_card_image">
                                <img src="assets/img/car2.jpg" alt="ads" />
                            </div>
                            <div class="ads_card_content">
                                <div class="meta d-flex justify-content-between">
                                    <p>Old School</p>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single_ads_card ">
                            <div class="ads_card_image">
                                <img src="assets/img/car3.jpg" alt="ads" />
                            </div>
                            <div class="ads_card_content">
                                <div class="meta d-flex justify-content-between">
                                    <p>Audi E-tron GT</p>
    ...
    <!-- <section class="blog_area pt-115 pb-0">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center pb-15">
    ...
    <footer class="footer_area">
        <div class="footer_widget pt-70 pb-40">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
