...
<!-- Mirrored from demo.graygrids.com/themes/classified/favourite-ads.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 16:10:18 GMT -->

<head>
    <meta charset="utf-8">

    <!--====== Title ======-->
    <title> My Favourites | ClassiFied</title>
                        ...
                        <div class="profile_user">
                            ...
                            <div class="user_list">
                                <ul>
                                    ...
                                    <li><a class="active" href="favourite-ads.php"><i class="fal fa-heart"></i> My Favourites</a></li>
                ...
                <div class="col-lg-9">
                    <div class="my_ads mt-50">
                        ...
                        <div class="my_ads_menu">
                            <ul class="ads_menu">
                                <li><a class="active" href="#">Featured (12)</a></li>
                            </ul>
                        </div>
